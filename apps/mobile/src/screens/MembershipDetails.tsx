...
import YouTubeMemberModal from './YouTubeMemberModal';
...
const MembershipDetails = ({ navigation }: MembershipDetailsProps) => {
  ...
  const youtubeMemberModalRef = useRef<BottomSheetModal>(null);

  const handlePurchaseModal = () => bottomSheetModalRef.current?.present();
  const handleYoutubeModal = () => youtubeMemberModalRef.current?.present();
            ...
            <View className="px-6 mt-24">
              ...
              <View className="mt-7">
                ...
                <SubscriptionCard
                  ...
                  onPress={handleYoutubeModal}
                />
              </View>
            </View>
          </View>
        </ScrollView>
        <PurchaseModal ref={bottomSheetModalRef} />
        <YouTubeMemberModal ref={youtubeMemberModalRef} />
      </BottomSheetModalProvider>
